...
- [How to Write a Bash Script](https://linuxconfig.org/bash-scripting-tutorial):A bash scripting tutorial.
- [Bash Exercises](https://exercism.org/tracks/bash/exercises): Explore 90+ exercises for learning bash.
