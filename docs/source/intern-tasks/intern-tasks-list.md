...
4. [Introduction to Linux](../fundamentals/intro-to-linux)
5. [Learning Vim](../fundamentals/learning-vim)
...
9. [BashBlaze: 7 Days of Bash Scripting](../intern-tasks/7-days-of-bash-scripting)
10. [Using Thunderbird](../applications/using-thunderbird)
...
14. [Using Salt](../applications/using-salt)
15. [Using Screen and Tmux](../fundamentals/using-screen-and-tmux)
16. [Running Python on the Cluster](../cluster/running-python-on-the-cluster)
