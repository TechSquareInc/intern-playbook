...
- [Power and Energy Consumption of HPC Systems](https://www.youtube.com/watch?v=d_aW6nDoYUg): In depth demo of how much power and energy is consumed by HPC systems.
- [Fundamentals of Data Center Power](https://www.youtube.com/watch?v=oXX2ledIIBc): Learn power basics and key terms in this helpful video.
- [Wye-Connected Load](https://www.mathworks.com/help/sps/ref/wyeconnectedload.html): Learn how three-phase loads behave when connected to a three-phase source.
