...
3. Learn the skills required to sysadmin a remote Linux server from the command line: [Linux Upskill Challenge](https://linuxupskillchallenge.org/#start-here).
